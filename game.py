...
bg_image = pygame.image.load('img/sky.jpg')
...
class Player():
    ...
    def reset(self, x, y):
        ...
        for num in range(1, 12):        
            img_right = pygame.image.load(f'Player\p1_walk\PNG\p1_walk{num}.png')
...
class World():
    def __init__(self, data):
        ...
        grass_img = pygame.image.load('img/dirt.jpg')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load('Enemies/blockerMad.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class Exit(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self) 
        img = pygame.image.load('img/doorOpen.png')
